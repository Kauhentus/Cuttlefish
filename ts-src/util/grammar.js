...
var grammar = {
    ...
    {"name": "closure", "symbols": ["closure$ebnf$1"], "postprocess": 
        data => ({
            label: 'closure',
            statements: data[0]
        })
        },
    {"name": "statement", "symbols": ["expression", "__"], "postprocess": 
        data => ({
            label: 'statement',
            type: 'expression',
            value: data[0]
    ...
    {"name": "IMPORT", "symbols": [{"literal":"import"}, "_", "IMPORT_STATEMENT"], "postprocess":  
        data => ({
            label: 'statement',
    ...
    {"name": "IMPORT", "symbols": [{"literal":"import"}, "IMPORT$ebnf$1", "_", "IMPORT_STATEMENT"], "postprocess":  
        data => ({
            label: 'statement',
            type: "import_statements",
            modules: [
    ...
    {"name": "IMPORT", "symbols": [{"literal":"import"}, "_", {"literal":"external"}, "_", "IMPORT_STATEMENT"], "postprocess":  
        data => ({
            label: 'statement',
    ...
    {"name": "IMPORT", "symbols": [{"literal":"import"}, "_", {"literal":"external"}, "IMPORT$ebnf$2", "_", "IMPORT_STATEMENT"], "postprocess":  
        data => ({
            label: 'statement',
            type: "import_external_statements",
            modules: [
    ...
    {"name": "IMPORT_STATEMENT", "symbols": ["variable"], "postprocess":  
        data => ({
            label: "module",
            module: data[0],
            nickname: undefined,
    ...
    {"name": "IMPORT_STATEMENT", "symbols": ["variable", "_", {"literal":"from"}, "_", "expression"], "postprocess": 
        data => ({
            label: "module",
            module: data[4],
            nickname: undefined,
    ...
    {"name": "IMPORT_STATEMENT", "symbols": ["expression", "_", {"literal":"as"}, "_", "variable"], "postprocess": 
        data => ({
            label: "module",
            module: data[0],
            nickname: data[4],
    ...
    {"name": "IMPORT_STATEMENT", "symbols": ["variable", "_", {"literal":"from"}, "_", "expression", "_", {"literal":"as"}, "_", "variable"], "postprocess": 
        data => ({
            label: "module",
            module: data[4],
            nickname: data[8],
    ...
    {"name": "EXPORT", "symbols": [{"literal":"export"}, "_", "expression", "_", {"literal":"as"}, "_", "variable"], "postprocess":  
        data => ({
            label: 'export',
            module: data[2],
            name: data[6],
    ...
    {"name": "EXPORT", "symbols": [{"literal":"export"}, "_", {"literal":"default"}, "_", "expression"], "postprocess":  
        data => ({
            label: 'export',
            module: data[4],
            name: 'default',
    ...
    {"name": "ASSIGNMENT", "symbols": ["expression", "_", {"literal":"="}, "_", "expression"], "postprocess": 
        data => ({
            label: 'statement',
            type: 'assignment',
            variable: data[0],
    ...
    {"name": "RETURN", "symbols": [{"literal":"return"}, "_", "expression"], "postprocess": 
        data => ({
            label: 'statement',
            type: 'return',
            value: data[2]
    ...
    {"name": "CLASS_BLOCK", "symbols": [{"literal":"class"}, "_", "expression", "_", {"literal":"with"}, "_", "expression", "_", {"literal":":"}, "_", (lexer.has("eol") ? {type: "eol"} : eol), (lexer.has("indent") ? {type: "indent"} : indent), "closure"], "postprocess": 
        data => ({
            label: 'statement',
            type: 'class',
            name: data[2],
    ...
    {"name": "WHILE_BLOCK", "symbols": [{"literal":"while"}, "_", "expression", "_", {"literal":":"}, "_", (lexer.has("eol") ? {type: "eol"} : eol), (lexer.has("indent") ? {type: "indent"} : indent), "closure"], "postprocess": 
        data => ({
            label: 'statement',
            type: 'while_block',
            conditional: data[2],
    ...
    {"name": "FOR_BLOCK", "symbols": [{"literal":"for"}, "_", "expression", "_", {"literal":"in"}, "_", "expression", "_", {"literal":":"}, "_", (lexer.has("eol") ? {type: "eol"} : eol), (lexer.has("indent") ? {type: "indent"} : indent), "closure"], "postprocess": 
        data => ({
            label: 'statement',
            type: 'for_block',
            iteratee: data[2],
    ...
    {"name": "IF_BLOCK", "symbols": [{"literal":"if"}, "_", "expression", "_", {"literal":":"}, "_", (lexer.has("eol") ? {type: "eol"} : eol), (lexer.has("indent") ? {type: "indent"} : indent), "closure"], "postprocess": 
        data => ({
            label: 'statement',
            type: 'if_block',
    ...
    {"name": "IF_BLOCK", "symbols": [{"literal":"if"}, "_", "expression", "_", {"literal":":"}, "_", (lexer.has("eol") ? {type: "eol"} : eol), (lexer.has("indent") ? {type: "indent"} : indent), "closure", (lexer.has("dedent") ? {type: "dedent"} : dedent), {"literal":"else"}, "_", {"literal":":"}, "_", (lexer.has("eol") ? {type: "eol"} : eol), (lexer.has("indent") ? {type: "indent"} : indent), "closure"], "postprocess": 
        data => ({
            label: 'statement',
            type: 'if_block',
            first_conditional: data[2],
    ...
    {"name": "IF_BLOCK", "symbols": [{"literal":"if"}, "_", "expression", "_", {"literal":":"}, "_", (lexer.has("eol") ? {type: "eol"} : eol), (lexer.has("indent") ? {type: "indent"} : indent), "closure", (lexer.has("dedent") ? {type: "dedent"} : dedent), "IF_BLOCK$ebnf$2", {"literal":"else"}, "_", {"literal":":"}, "_", (lexer.has("eol") ? {type: "eol"} : eol), (lexer.has("indent") ? {type: "indent"} : indent), "closure"], "postprocess": 
        data => ({
            label: 'statement',
            type: 'if_block',
            first_conditional: data[2],
    ...
    {"name": "DO_BLOCK", "symbols": [{"literal":"with"}, "_", "expression", "_", {"literal":"do"}, "_", {"literal":":"}, "_", (lexer.has("eol") ? {type: "eol"} : eol), (lexer.has("indent") ? {type: "indent"} : indent), "closure"], "postprocess": 
        data => ({
    ...
    {"name": "PIPELINE_BLOCK", "symbols": [{"literal":"{"}, "_", (lexer.has("eol") ? {type: "eol"} : eol), (lexer.has("indent") ? {type: "indent"} : indent), "PIPELINE_BLOCK$ebnf$1", (lexer.has("dedent") ? {type: "dedent"} : dedent), "_", {"literal":"}"}], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "LAMBDA", "symbols": ["LAMBDA", "_", {"literal":"=>"}, "_", "RH_FUNC_CALL"], "postprocess": 
        data => ({
    ...
    {"name": "RH_FUNC_CALL", "symbols": ["RH_FUNC_CALL", "_", {"literal":"<-"}, "_", "PIPELINE_CALL"], "postprocess": 
        data => ({
            label: 'function_call',
            function: data[0],
            arguments: [data[4]],
    ...
    {"name": "PIPELINE_CALL", "symbols": ["PIPELINE_CALL", "_", {"literal":"~"}, "_", "FUNCTION_CALL"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "FUNCTION_CALL", "symbols": ["TERNARY", "FUNCTION_CALL$ebnf$1"], "postprocess": 
        data => ({
            label: 'function_call',
            function: data[0],
    ...
    {"name": "TERNARY", "symbols": ["LIFTING_FUNCS", "_", {"literal":"?"}, "_", "LIFTING_FUNCS", "_", {"literal":":"}, "_", "TERNARY"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "LIFTING_FUNCS", "symbols": ["LIFTING_FUNCS", "_", {"literal":"<$>"}, "_", "FILTER"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "FILTER", "symbols": ["FILTER", "_", (lexer.has("double_escape") ? {type: "double_escape"} : double_escape), "_", "LOGIC"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "FILTER", "symbols": ["FILTER", "_", (lexer.has("reduce_right") ? {type: "reduce_right"} : reduce_right), "_", "LOGIC"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "FILTER", "symbols": ["FILTER", "_", (lexer.has("reduce_left") ? {type: "reduce_left"} : reduce_left), "_", "LOGIC"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "FILTER", "symbols": ["FILTER", "_", (lexer.has("any") ? {type: "any"} : any), "_", "LOGIC"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "FILTER", "symbols": ["FILTER", "_", (lexer.has("all") ? {type: "all"} : all), "_", "LOGIC"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "LOGIC", "symbols": ["LOGIC", "_", {"literal":"&&"}, "_", "COMPARE"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "COMPARE", "symbols": ["COMPARE", "_", {"literal":">"}, "_", "AS"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "AS", "symbols": ["AS", "_", {"literal":"+"}, "_", "MDM"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "MDM", "symbols": ["MDM", "_", {"literal":"*"}, "_", "EXP"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "EXP", "symbols": ["EXP", "_", {"literal":"**"}, "_", "MEMA_B"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "MEMA_B", "symbols": ["MEMA_B", "_", {"literal":"["}, "_", "expression", "_", {"literal":"]"}], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "LIFT_MAP", "symbols": ["LIFT_MAP", "_", {"literal":"'"}, "_", "MEMA_D"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "MEMA_D", "symbols": ["MEMA_D", "_", {"literal":"."}, "_", "variable"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "UNARY", "symbols": [{"literal":"!"}, "_", "P"], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "UNARY", "symbols": [{"literal":"("}, "_", {"literal":"-"}, "_", "P", "_", {"literal":")"}], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "P", "symbols": [{"literal":"("}, "_", "expression", "_", "P$subexpression$1", "_", {"literal":")"}], "postprocess":  
        data => {
    ...
    {"name": "P", "symbols": [{"literal":"("}, "_", "expression", "_", {"literal":")"}], "postprocess": data => data[2]},
    ...
    {"name": "array", "symbols": [{"literal":"["}, "_", "expression", "_", {"literal":","}, "_", {"literal":"]"}], "postprocess": 
        data => ({
            label: 'atom',
            type: 'array',
            values: [data[2]]
    ...
    {"name": "array", "symbols": [{"literal":"["}, "array$ebnf$1", "_", "expression", "_", {"literal":"]"}], "postprocess": 
        data => ({
            label: 'atom',
            type: 'array',
            values: [
    ...
    {"name": "array", "symbols": [{"literal":"["}, "_", "expression", "_", {"literal":".."}, "_", "expression", "_", {"literal":"]"}], "postprocess": 
        data => ({
            label: 'function_call',
    ...
    {"name": "array", "symbols": [{"literal":"["}, "_", "expression", "_", {"literal":","}, "_", "expression", "_", {"literal":".."}, "_", "expression", "_", {"literal":"]"}], "postprocess": 
        data => ({
            label: 'function_call',
            function: wrapVariable('range'),
    ...
    {"name": "tuple", "symbols": [{"literal":"("}, "_", {"literal":")"}], "postprocess": 
        data => ({
            label: 'atom',
            type: 'tuple',
            values: []
    ...
    {"name": "tuple", "symbols": [{"literal":"("}, "_", "expression", "_", {"literal":","}, "_", {"literal":")"}], "postprocess": 
        data => ({
            label: 'atom',
            type: 'tuple',
            values: [data[2]]
    ...
    {"name": "tuple", "symbols": [{"literal":"("}, "tuple$ebnf$1", "_", "expression", "_", {"literal":")"}], "postprocess": 
        data => ({
            label: 'atom',
            type: 'tuple',
            values: [
    ...
    {"name": "variable", "symbols": [(lexer.has("word") ? {type: "word"} : word)], "postprocess": 
        data => ({
            label: 'atom',
            type: 'variable',
            value: data[0].value
    ...
    {"name": "boolean", "symbols": [(lexer.has("boolean") ? {type: "boolean"} : boolean)], "postprocess": 
        data => ({
            label: 'atom',
            type: 'boolean',
